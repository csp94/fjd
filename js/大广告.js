...
for(var i=0;i<menus.length;i++){
	...
	menus[i].onmouseover=function(){
		cates[this.index].style.display="block";
		ads.style.display="none";
		login.style.display="none";
	}
	menus[i].onmouseleave=function(){
		cates[this.index].style.display="none";
...
$(function(){
	...
	var alls = $(".all");
	$(".lift_list .scroll").mouseover(function(){
		var top = $(alls)[$(this).index()].offsetTop;
		console.log(top);
